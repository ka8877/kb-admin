// frontend/src/pages/management/questions-category/validation/questionsCategoryValidation.ts

/**
 * 질문 카테고리 공통 Validation 규칙
 */
...
export interface QuestionsCategoryData {
  category_nm?: string;
  service_cd?: string;
  status_code?: 'Y' | 'N';
}
 ...
 */
export class QuestionsCategoryValidator {
  // 제어 문자 검증
  ...
  // 전체 데이터 validation
  static validateAll(data: QuestionsCategoryData): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
