// frontend/src/pages/management/age-group/validation/ageGroupValidation.ts

/**
 * 연령그룹 공통 Validation 규칙
 */
 ...
 */
export class AgeGroupValidator {
  // 제어 문자 검증
  ...
  // 전체 데이터 validation
  static validateAll(data: AgeGroupData): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
